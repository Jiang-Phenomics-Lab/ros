...
void InitDefaultsLidarScanImpl() {
...
void InitDefaultsLidarScan() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsLidarScanImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "scan.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
LidarScan::LidarScan()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_scan_2eproto::InitDefaultsLidarScan();
  }
  SharedCtor();
