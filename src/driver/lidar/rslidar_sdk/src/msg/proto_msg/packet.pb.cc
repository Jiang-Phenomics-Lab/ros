...
void InitDefaultsLidarPacketImpl() {
...
void InitDefaultsLidarPacket() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsLidarPacketImpl);
}
...
LidarPacket::LidarPacket()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_packet_2eproto::InitDefaultsLidarPacket();
  }
  SharedCtor();
