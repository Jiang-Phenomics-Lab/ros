...
void InitDefaultsIntensityCostFunctionOptionsImpl() {
...
void InitDefaultsIntensityCostFunctionOptions() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsIntensityCostFunctionOptionsImpl);
}
...
void InitDefaultsCeresScanMatcherOptions3DImpl() {
  ...
  protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto::InitDefaultsIntensityCostFunctionOptions();
  {
...
void InitDefaultsCeresScanMatcherOptions3D() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsCeresScanMatcherOptions3DImpl);
}
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_intensity_cost_function_options()));
        } else {
          goto handle_unusual;
        }
        break;
