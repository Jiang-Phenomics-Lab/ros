...
void InitDefaultsGrid2DImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto::InitDefaultsMapLimits();
  protobuf_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto::InitDefaultsGrid2D_CellBox();
  protobuf_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto::InitDefaultsProbabilityGrid();
  protobuf_cartographer_2fmapping_2fproto_2ftsdf_5f2d_2eproto::InitDefaultsTSDF2D();
  {
...
void AddDescriptorsImpl() {
  ...
  ::protobuf_cartographer_2fmapping_2fproto_2fmap_5flimits_2eproto::AddDescriptors();
  ::protobuf_cartographer_2fmapping_2fproto_2fprobability_5fgrid_2eproto::AddDescriptors();
  ::protobuf_cartographer_2fmapping_2fproto_2ftsdf_5f2d_2eproto::AddDescriptors();
}
...
Grid2D::Grid2D()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto::InitDefaultsGrid2D();
  }
  SharedCtor();
