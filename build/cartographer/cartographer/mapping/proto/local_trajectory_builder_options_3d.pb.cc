...
void InitDefaultsLocalTrajectoryBuilderOptions3DImpl() {
  ...
  protobuf_cartographer_2ftransform_2fproto_2ftimestamped_5ftransform_2eproto::InitDefaultsTimestampedTransform();
  protobuf_cartographer_2fsensor_2fproto_2fsensor_2eproto::InitDefaultsImuData();
  protobuf_cartographer_2fmapping_2fproto_2fsubmaps_5foptions_5f3d_2eproto::InitDefaultsSubmapsOptions3D();
  {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 19: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_initial_poses()));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 20: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_initial_imu_data()));
        } else {
          goto handle_unusual;
        }
        break;
