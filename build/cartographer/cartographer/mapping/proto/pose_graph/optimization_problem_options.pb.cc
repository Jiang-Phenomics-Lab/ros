...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::optimization::proto::OptimizationProblemOptions, fixed_frame_pose_use_tolerant_loss_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::optimization::proto::OptimizationProblemOptions, fixed_frame_pose_tolerant_loss_param_a_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::optimization::proto::OptimizationProblemOptions, fixed_frame_pose_tolerant_loss_param_b_),
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::optimization::proto::OptimizationProblemOptions, use_online_imu_extrinsics_in_3d_),
