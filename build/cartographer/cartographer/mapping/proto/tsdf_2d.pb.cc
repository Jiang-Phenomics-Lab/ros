...
void InitDefaultsTSDF2D() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsTSDF2DImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "cartographer/mapping/proto/tsdf_2d.proto", schemas, file_default_instances, TableStruct::offsets, factory,
