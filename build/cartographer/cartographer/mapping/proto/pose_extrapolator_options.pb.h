...
void AddDescriptors();
void InitDefaultsConstantVelocityPoseExtrapolatorOptionsImpl();
void InitDefaultsConstantVelocityPoseExtrapolatorOptions();
void InitDefaultsImuBasedPoseExtrapolatorOptionsImpl();
void InitDefaultsImuBasedPoseExtrapolatorOptions();
void InitDefaultsPoseExtrapolatorOptionsImpl();
void InitDefaultsPoseExtrapolatorOptions();
inline void InitDefaults() {
  InitDefaultsConstantVelocityPoseExtrapolatorOptions();
  InitDefaultsImuBasedPoseExtrapolatorOptions();
  InitDefaultsPoseExtrapolatorOptions();
}
}  // namespace protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto
...
class ConstantVelocityPoseExtrapolatorOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.ConstantVelocityPoseExtrapolatorOptions) */ {
 ...
 private:
  ...
  friend void ::protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::InitDefaultsConstantVelocityPoseExtrapolatorOptionsImpl();
};
// -------------------------------------------------------------------
...
class ImuBasedPoseExtrapolatorOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.ImuBasedPoseExtrapolatorOptions) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::TableStruct;
  friend void ::protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::InitDefaultsImuBasedPoseExtrapolatorOptionsImpl();
};
// -------------------------------------------------------------------
...
class PoseExtrapolatorOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseExtrapolatorOptions) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::TableStruct;
  friend void ::protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::InitDefaultsPoseExtrapolatorOptionsImpl();
};
// ===================================================================
...
inline const ::cartographer::common::proto::CeresSolverOptions& ImuBasedPoseExtrapolatorOptions::solver_options() const {
  const ::cartographer::common::proto::CeresSolverOptions* p = solver_options_;
...
inline void ImuBasedPoseExtrapolatorOptions::set_allocated_solver_options(::cartographer::common::proto::CeresSolverOptions* solver_options) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(solver_options_);
  }
  if (solver_options) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      solver_options = ::google::protobuf::internal::GetOwnedMessage(
...
inline const ::cartographer::mapping::proto::ConstantVelocityPoseExtrapolatorOptions& PoseExtrapolatorOptions::constant_velocity() const {
  const ::cartographer::mapping::proto::ConstantVelocityPoseExtrapolatorOptions* p = constant_velocity_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseExtrapolatorOptions.constant_velocity)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping::proto::ConstantVelocityPoseExtrapolatorOptions*>(
...
inline void PoseExtrapolatorOptions::set_allocated_constant_velocity(::cartographer::mapping::proto::ConstantVelocityPoseExtrapolatorOptions* constant_velocity) {
  ...
  if (constant_velocity) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      constant_velocity = ::google::protobuf::internal::GetOwnedMessage(
...
inline const ::cartographer::mapping::proto::ImuBasedPoseExtrapolatorOptions& PoseExtrapolatorOptions::imu_based() const {
  const ::cartographer::mapping::proto::ImuBasedPoseExtrapolatorOptions* p = imu_based_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.PoseExtrapolatorOptions.imu_based)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping::proto::ImuBasedPoseExtrapolatorOptions*>(
...
inline void PoseExtrapolatorOptions::set_allocated_imu_based(::cartographer::mapping::proto::ImuBasedPoseExtrapolatorOptions* imu_based) {
  ...
  if (imu_based) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      imu_based = ::google::protobuf::internal::GetOwnedMessage(
