...
void InitDefaultsPoseGraphOptions_OverlappingSubmapsTrimmerOptions2D() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsPoseGraphOptions_OverlappingSubmapsTrimmerOptions2DImpl);
}
...
void InitDefaultsPoseGraphOptionsImpl() {
  ...
  protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_5foptions_2eproto::InitDefaultsPoseGraphOptions_OverlappingSubmapsTrimmerOptions2D();
  {
...
void InitDefaultsPoseGraphOptions() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsPoseGraphOptionsImpl);
}
...
PoseGraphOptions::PoseGraphOptions()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_5foptions_2eproto::InitDefaultsPoseGraphOptions();
  }
  SharedCtor();
