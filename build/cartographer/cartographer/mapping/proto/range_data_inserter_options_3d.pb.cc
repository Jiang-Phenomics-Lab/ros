...
void InitDefaultsRangeDataInserterOptions3D() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsRangeDataInserterOptions3DImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "cartographer/mapping/proto/range_data_inserter_options_3d.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
RangeDataInserterOptions3D::RangeDataInserterOptions3D()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_cartographer_2fmapping_2fproto_2frange_5fdata_5finserter_5foptions_5f3d_2eproto::InitDefaultsRangeDataInserterOptions3D();
  }
  SharedCtor();
