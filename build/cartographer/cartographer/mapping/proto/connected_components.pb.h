...
void AddDescriptors();
void InitDefaultsConnectedComponents_ConnectedComponentImpl();
void InitDefaultsConnectedComponents_ConnectedComponent();
void InitDefaultsConnectedComponentsImpl();
void InitDefaultsConnectedComponents();
inline void InitDefaults() {
  InitDefaultsConnectedComponents_ConnectedComponent();
  InitDefaultsConnectedComponents();
}
}  // namespace protobuf_cartographer_2fmapping_2fproto_2fconnected_5fcomponents_2eproto
...
class ConnectedComponents_ConnectedComponent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.ConnectedComponents.ConnectedComponent) */ {
 ...
 private:
  ...
  friend void ::protobuf_cartographer_2fmapping_2fproto_2fconnected_5fcomponents_2eproto::InitDefaultsConnectedComponents_ConnectedComponentImpl();
};
// -------------------------------------------------------------------
...
class ConnectedComponents : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.ConnectedComponents) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_cartographer_2fmapping_2fproto_2fconnected_5fcomponents_2eproto::TableStruct;
  friend void ::protobuf_cartographer_2fmapping_2fproto_2fconnected_5fcomponents_2eproto::InitDefaultsConnectedComponentsImpl();
};
// ===================================================================
