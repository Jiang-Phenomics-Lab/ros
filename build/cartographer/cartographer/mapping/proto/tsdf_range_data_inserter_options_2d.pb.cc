...
void InitDefaultsTSDFRangeDataInserterOptions2DImpl() {
  ...
  protobuf_cartographer_2fmapping_2fproto_2fnormal_5festimation_5foptions_5f2d_2eproto::InitDefaultsNormalEstimationOptions2D();
  {
...
void InitDefaultsTSDFRangeDataInserterOptions2D() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsTSDFRangeDataInserterOptions2DImpl);
}
...
TSDFRangeDataInserterOptions2D::TSDFRangeDataInserterOptions2D()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_cartographer_2fmapping_2fproto_2ftsdf_5frange_5fdata_5finserter_5foptions_5f2d_2eproto::InitDefaultsTSDFRangeDataInserterOptions2D();
  }
  SharedCtor();
