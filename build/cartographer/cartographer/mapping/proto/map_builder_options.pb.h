...
void AddDescriptors();
void InitDefaultsMapBuilderOptionsImpl();
void InitDefaultsMapBuilderOptions();
inline void InitDefaults() {
  InitDefaultsMapBuilderOptions();
}
}  // namespace protobuf_cartographer_2fmapping_2fproto_2fmap_5fbuilder_5foptions_2eproto
...
class MapBuilderOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.MapBuilderOptions) */ {
 ...
 private:
  ...
  friend void ::protobuf_cartographer_2fmapping_2fproto_2fmap_5fbuilder_5foptions_2eproto::InitDefaultsMapBuilderOptionsImpl();
};
// ===================================================================
...
inline void MapBuilderOptions::set_allocated_pose_graph_options(::cartographer::mapping::proto::PoseGraphOptions* pose_graph_options) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(pose_graph_options_);
  }
  if (pose_graph_options) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      pose_graph_options = ::google::protobuf::internal::GetOwnedMessage(
