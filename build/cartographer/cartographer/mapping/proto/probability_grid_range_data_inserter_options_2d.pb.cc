...
void InitDefaultsProbabilityGridRangeDataInserterOptions2D() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsProbabilityGridRangeDataInserterOptions2DImpl);
}
...
ProbabilityGridRangeDataInserterOptions2D::ProbabilityGridRangeDataInserterOptions2D()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto::InitDefaultsProbabilityGridRangeDataInserterOptions2D();
  }
  SharedCtor();
