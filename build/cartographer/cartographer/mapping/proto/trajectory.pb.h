...
void AddDescriptors();
void InitDefaultsTrajectory_NodeImpl();
void InitDefaultsTrajectory_Node();
void InitDefaultsTrajectory_SubmapImpl();
void InitDefaultsTrajectory_Submap();
void InitDefaultsTrajectoryImpl();
void InitDefaultsTrajectory();
inline void InitDefaults() {
  InitDefaultsTrajectory_Node();
  InitDefaultsTrajectory_Submap();
...
class Trajectory_Node : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Trajectory.Node) */ {
 ...
 private:
  ...
  friend void ::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_2eproto::InitDefaultsTrajectory_NodeImpl();
};
// -------------------------------------------------------------------
...
class Trajectory_Submap : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Trajectory.Submap) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_2eproto::TableStruct;
  friend void ::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_2eproto::InitDefaultsTrajectory_SubmapImpl();
};
// -------------------------------------------------------------------
...
class Trajectory : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Trajectory) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_2eproto::TableStruct;
  friend void ::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_2eproto::InitDefaultsTrajectoryImpl();
};
// ===================================================================
