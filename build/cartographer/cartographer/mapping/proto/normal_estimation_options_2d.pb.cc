...
void InitDefaultsNormalEstimationOptions2DImpl() {
...
void InitDefaultsNormalEstimationOptions2D() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsNormalEstimationOptions2DImpl);
}
