...
void InitDefaultsConstantVelocityPoseExtrapolatorOptions() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsConstantVelocityPoseExtrapolatorOptionsImpl);
}
...
void InitDefaultsImuBasedPoseExtrapolatorOptions() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsImuBasedPoseExtrapolatorOptionsImpl);
}
...
void InitDefaultsPoseExtrapolatorOptionsImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::InitDefaultsConstantVelocityPoseExtrapolatorOptions();
  protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::InitDefaultsImuBasedPoseExtrapolatorOptions();
  {
...
void InitDefaultsPoseExtrapolatorOptions() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsPoseExtrapolatorOptionsImpl);
}
