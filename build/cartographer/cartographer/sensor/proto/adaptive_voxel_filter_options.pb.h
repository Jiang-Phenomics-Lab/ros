...
void AddDescriptors();
void InitDefaultsAdaptiveVoxelFilterOptionsImpl();
void InitDefaultsAdaptiveVoxelFilterOptions();
inline void InitDefaults() {
  InitDefaultsAdaptiveVoxelFilterOptions();
}
}  // namespace protobuf_cartographer_2fsensor_2fproto_2fadaptive_5fvoxel_5ffilter_5foptions_2eproto
...
class AdaptiveVoxelFilterOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.sensor.proto.AdaptiveVoxelFilterOptions) */ {
 ...
 private:
  ...
  friend void ::protobuf_cartographer_2fsensor_2fproto_2fadaptive_5fvoxel_5ffilter_5foptions_2eproto::InitDefaultsAdaptiveVoxelFilterOptionsImpl();
};
// ===================================================================
