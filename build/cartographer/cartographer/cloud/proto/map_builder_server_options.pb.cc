...
void InitDefaultsMapBuilderServerOptionsImpl() {
  ...
  protobuf_cartographer_2fmapping_2fproto_2fmap_5fbuilder_5foptions_2eproto::InitDefaultsMapBuilderOptions();
  {
...
void InitDefaultsMapBuilderServerOptions() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsMapBuilderServerOptionsImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "cartographer/cloud/proto/map_builder_server_options.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
MapBuilderServerOptions::MapBuilderServerOptions()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_cartographer_2fcloud_2fproto_2fmap_5fbuilder_5fserver_5foptions_2eproto::InitDefaultsMapBuilderServerOptions();
  }
  SharedCtor();
...
MapBuilderServerOptions* MapBuilderServerOptions::New(::google::protobuf::Arena* arena) const {
  MapBuilderServerOptions* n = new MapBuilderServerOptions;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void MapBuilderServerOptions::SerializeWithCachedSizes(
  ...
  if (this->has_map_builder_options()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      4, *this->map_builder_options_, output);
  }
  ...
  if (this->has_map_builder_options()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        4, *this->map_builder_options_, deterministic, target);
  }
...
void MapBuilderServerOptions::InternalSwap(MapBuilderServerOptions* other) {
  ...
  uplink_server_address_.Swap(&other->uplink_server_address_);
