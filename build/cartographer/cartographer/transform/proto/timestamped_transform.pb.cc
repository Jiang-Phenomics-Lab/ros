...
void InitDefaultsTimestampedTransformImpl() {
...
void InitDefaultsTimestampedTransform() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsTimestampedTransformImpl);
}
