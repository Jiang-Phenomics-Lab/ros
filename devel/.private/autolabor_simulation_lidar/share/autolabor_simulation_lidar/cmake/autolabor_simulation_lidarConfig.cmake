...
if("TRUE" STREQUAL "TRUE")
  set(autolabor_simulation_lidar_SOURCE_PREFIX /home/autolabor/catkin_ws/src/simulation/autolabor_simulation_lidar)
  set(autolabor_simulation_lidar_DEVEL_PREFIX /home/autolabor/catkin_ws/devel/.private/autolabor_simulation_lidar)
  ...
  set(autolabor_simulation_lidar_INSTALL_PREFIX /home/autolabor/catkin_ws/install)
...
if(NOT "/home/autolabor/catkin_ws/src/simulation/autolabor_simulation_lidar/include " STREQUAL " ")
  set(autolabor_simulation_lidar_INCLUDE_DIRS "")
  set(_include_dirs "/home/autolabor/catkin_ws/src/simulation/autolabor_simulation_lidar/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'autolabor_simulation_lidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/autolabor/catkin_ws/src/simulation/autolabor_simulation_lidar/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT autolabor_simulation_lidar_NUM_DUMMY_TARGETS)
      set(autolabor_simulation_lidar_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::autolabor_simulation_lidar::wrapped-linker-option${autolabor_simulation_lidar_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR autolabor_simulation_lidar_NUM_DUMMY_TARGETS "${autolabor_simulation_lidar_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::autolabor_simulation_lidar::wrapped-linker-option${autolabor_simulation_lidar_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND autolabor_simulation_lidar_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/autolabor/catkin_ws/devel/.private/autolabor_simulation_lidar/lib;/home/autolabor/catkin_ws/devel/lib;/opt/ros/melodic/lib)
