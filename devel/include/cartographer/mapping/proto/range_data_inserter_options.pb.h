...
inline void InitDefaults() {
  InitDefaultsRangeDataInserterOptions();
}
}  // namespace protobuf_cartographer_2fmapping_2fproto_2frange_5fdata_5finserter_5foptions_2eproto
...
const RangeDataInserterOptions_RangeDataInserterType RangeDataInserterOptions_RangeDataInserterType_RangeDataInserterType_MAX = RangeDataInserterOptions_RangeDataInserterType_TSDF_INSERTER_2D;
...
class RangeDataInserterOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.RangeDataInserterOptions) */ {
 public:
  ...
  static const RangeDataInserterType TSDF_INSERTER_2D =
  ...
  static const int kTsdfRangeDataInserterOptions2DFieldNumber = 3;
 ...
 private:
  ...
  friend void ::protobuf_cartographer_2fmapping_2fproto_2frange_5fdata_5finserter_5foptions_2eproto::InitDefaultsRangeDataInserterOptionsImpl();
};
// ===================================================================
...
inline void RangeDataInserterOptions::set_allocated_probability_grid_range_data_inserter_options_2d(::cartographer::mapping::proto::ProbabilityGridRangeDataInserterOptions2D* probability_grid_range_data_inserter_options_2d) {
  ...
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(probability_grid_range_data_inserter_options_2d_);
  }
  if (probability_grid_range_data_inserter_options_2d) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      probability_grid_range_data_inserter_options_2d = ::google::protobuf::internal::GetOwnedMessage(
...
inline const ::cartographer::mapping::proto::TSDFRangeDataInserterOptions2D& RangeDataInserterOptions::tsdf_range_data_inserter_options_2d() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping::proto::TSDFRangeDataInserterOptions2D*>(
...
inline ::cartographer::mapping::proto::TSDFRangeDataInserterOptions2D* RangeDataInserterOptions::mutable_tsdf_range_data_inserter_options_2d() {
  ...
  if (tsdf_range_data_inserter_options_2d_ == NULL) {
    tsdf_range_data_inserter_options_2d_ = new ::cartographer::mapping::proto::TSDFRangeDataInserterOptions2D;
  }
...
inline void RangeDataInserterOptions::set_allocated_tsdf_range_data_inserter_options_2d(::cartographer::mapping::proto::TSDFRangeDataInserterOptions2D* tsdf_range_data_inserter_options_2d) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(tsdf_range_data_inserter_options_2d_);
  }
  if (tsdf_range_data_inserter_options_2d) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      tsdf_range_data_inserter_options_2d = ::google::protobuf::internal::GetOwnedMessage(
