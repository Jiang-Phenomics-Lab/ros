...
inline void InitDefaults() {
  InitDefaultsIntensityCostFunctionOptions();
...
class IntensityCostFunctionOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.scan_matching.proto.IntensityCostFunctionOptions) */ {
 public:
  ...
  inline IntensityCostFunctionOptions* New() const PROTOBUF_FINAL { return New(NULL); }

  IntensityCostFunctionOptions* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto::InitDefaultsIntensityCostFunctionOptionsImpl();
};
// -------------------------------------------------------------------
