...
void AddDescriptors();
void InitDefaultsTrajectoryNodeDataImpl();
void InitDefaultsTrajectoryNodeData();
inline void InitDefaults() {
  InitDefaultsTrajectoryNodeData();
}
}  // namespace protobuf_cartographer_2fmapping_2fproto_2ftrajectory_5fnode_5fdata_2eproto
...
class TrajectoryNodeData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TrajectoryNodeData) */ {
 ...
 private:
  ...
  friend void ::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_5fnode_5fdata_2eproto::InitDefaultsTrajectoryNodeDataImpl();
};
// ===================================================================
